...
@section('title', 'Rent House | Makanumber')
...
<section class="container border mt-2 mb-2 pt-2 pb-2" style="border-radius:3px;">
  <section class="row pl-2">
    <span>
      <a href="/">Home </a>
      <a href="/rent-house"> <i class="fa fa-angle-right"></i> <span style="color:#00B4A2;">Rent House</span></a>
...
<div class="container mt-5 pb-5">
  <div class="row mb-2">
    <div class="col-sm-8">
      <h3 class="ml-3" style="font-weight:bold;">{{$property->count()}} House for Rent</h3>
    </div>
