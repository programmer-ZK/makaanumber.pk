...
@section('title', 'Buy Apartment | Makanumber')
...
<section class="container  border mt-2 mb-2 pt-2 pb-2" style="border-radius:3px;">
  <section class="row pl-2">
    <span>
      ...
      <a href="/buy-apartment"> <i class="fa fa-angle-right"></i> <span style="color:#00B4A2;">Buy Apartment</span></a>
...
<?php
if ($property->count() > 1) {
  $props = "Apartments for Sale";
} else {
  $props = "Apartment for Sale";
}
...
<div class="container mt-5 pb-5">
  <div class="row mb-2">
    <div class="col-sm-8">
      <h3 class="ml-3" style="font-weight:bold;">{{$property->count()}} {{$props}}</h3>
    </div>
...
<script>
  $(document).ready(function() {
    ...
    $("#grid").click(function() {
      $('.list').show();
      $('.grid').hide();
      $('#grid').css('background-color', '#00B4A2');
    ...
    $("#list").click(function() {
      ...
      $('#list').css('background-color', '#00B4A2');
    });
