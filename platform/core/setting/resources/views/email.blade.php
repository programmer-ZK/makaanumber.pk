      ...
      <div class="wrapper-content pd-all-20" id="email-config-form">
        ...
        <div data-type="smtp" class="setting-wrapper @if (setting('email_driver', config('mail.default')) !== 'smtp') hidden @endif">
          <div class="form-group mb-3">
            ...
            <input data-counter="10" type="number" class="next-input" name="email_port" id="email_port" value="{{ setting('email_port', config('mail.mailers.smtp.port')) }}" placeholder="{{ trans('core/setting::setting.email.port_placeholder') }}">
          </div>
          <div class="form-group mb-3">
            <label class="text-title-field" for="email_host">{{ trans('core/setting::setting.email.host') }}</label>
            <input data-counter="60" type="text" class="next-input" name="email_host" id="email_host" value="{{ setting('email_host', config('mail.mailers.smtp.host')) }}" placeholder="{{ trans('core/setting::setting.email.host_placeholder') }}">
          </div>
          <div class="form-group mb-3">
            <label class="text-title-field" for="email_username">{{ trans('core/setting::setting.email.username') }}</label>
            <input data-counter="120" type="text" class="next-input" name="email_username" id="email_username" value="{{ setting('email_username', config('mail.mailers.smtp.username')) }}" placeholder="{{ trans('core/setting::setting.email.username_placeholder') }}">
          </div>
          <div class="form-group mb-3">
            <label class="text-title-field" for="email_password">{{ trans('core/setting::setting.email.password')  }}</label>
            <input data-counter="120" type="password" class="next-input" name="email_password" id="email_password" value="{{ setting('email_password', config('mail.mailers.smtp.password')) }}" placeholder="{{ trans('core/setting::setting.email.password_placeholder') }}">
          </div>
          <div class="form-group mb-3" style="margin-bottom: 1em;">
            ...
            <input data-counter="20" type="text" class="next-input" name="email_encryption" id="email_encryption" value="{{ setting('email_encryption', config('mail.mailers.smtp.encryption')) }}" placeholder="{{ trans('core/setting::setting.email.encryption_placeholder') }}">
          </div>
        </div>
        ...
        <div data-type="mailgun" class="setting-wrapper @if (setting('email_driver', config('mail.default')) !== 'mailgun') hidden @endif">
          <div class="form-group mb-3">
            ...
            <input data-counter="120" type="text" class="next-input" name="email_mail_gun_domain" id="email_mail_gun_domain" value="{{ setting('email_mail_gun_domain', config('services.mailgun.domain')) }}" placeholder="{{ trans('core/setting::setting.email.mail_gun_domain_placeholder') }}">
          </div>
          @if (!app()->environment('demo'))
          <div class="form-group mb-3">
            <label class="text-title-field" for="email_mail_gun_secret">{{ trans('core/setting::setting.email.mail_gun_secret')  }}</label>
            <input data-counter="120" type="text" class="next-input" name="email_mail_gun_secret" id="email_mail_gun_secret" value="{{ setting('email_mail_gun_secret', config('services.mailgun.secret')) }}" placeholder="{{ trans('core/setting::setting.email.mail_gun_secret_placeholder') }}">
          </div>
          @endif
          <div class="form-group mb-3" style="margin-bottom: 1em;">
            <label class="text-title-field" for="email_mail_gun_endpoint">{{ trans('core/setting::setting.email.mail_gun_endpoint') }}</label>
            <input data-counter="120" type="text" class="next-input" name="email_mail_gun_endpoint" id="email_mail_gun_endpoint" value="{{ setting('email_mail_gun_endpoint', config('services.mailgun.endpoint')) }}" placeholder="{{ trans('core/setting::setting.email.mail_gun_endpoint_placeholder') }}">
          </div>
        </div>
        ...
        <div data-type="ses" class="setting-wrapper @if (setting('email_driver', config('mail.default')) !== 'ses') hidden @endif">
          <div class="form-group mb-3">
            ...
            <input data-counter="120" type="text" class="next-input" name="email_ses_key" id="email_ses_key" value="{{ setting('email_ses_key', config('services.ses.key')) }}" placeholder="{{ trans('core/setting::setting.email.ses_key_placeholder') }}">
          </div>
          @if (!app()->environment('demo'))
          <div class="form-group mb-3">
            <label class="text-title-field" for="email_ses_secret">{{ trans('core/setting::setting.email.ses_secret')  }}</label>
            <input data-counter="120" type="text" class="next-input" name="email_ses_secret" id="email_ses_secret" value="{{ setting('email_ses_secret', config('services.ses.secret')) }}" placeholder="{{ trans('core/setting::setting.email.ses_secret_placeholder') }}">
          </div>
          @endif
          <div class="form-group mb-3" style="margin-bottom: 1em;">
            <label class="text-title-field" for="email_ses_region">{{ trans('core/setting::setting.email.ses_region') }}</label>
            <input data-counter="120" type="text" class="next-input" name="email_ses_region" id="email_ses_region" value="{{ setting('email_ses_region', config('services.ses.region')) }}" placeholder="{{ trans('core/setting::setting.email.ses_region_placeholder') }}">
          </div>
        </div>
        ...
        <div data-type="postmark" class="setting-wrapper @if (setting('email_driver', config('mail.default')) !== 'postmark') hidden @endif">
          ...
          <div class="form-group mb-3">
            ...
            <input data-counter="120" type="text" class="next-input" name="email_postmark_token" id="email_postmark_token" value="{{ setting('email_postmark_token', config('services.postmark.token')) }}" placeholder="{{ trans('core/setting::setting.email.postmark_token_placeholder') }}">
          </div>
          @endif
        </div>
        ...
        <div data-type="sendmail" class="setting-wrapper @if (setting('email_driver', config('mail.default')) !== 'sendmail') hidden @endif">
          <div class="form-group mb-3">
            ...
            <input type="text" class="next-input" name="email_sendmail_path" id="email_sendmail_path" value="{{ setting('email_sendmail_path', config('mail.mailers.sendmail.path')) }}" placeholder="{{ trans('core/setting::setting.email.sendmail_path') }}">
        ...
        <div data-type="log" class="setting-wrapper @if (setting('email_driver', config('mail.default')) !== 'log') hidden @endif">
          <div class="form-group mb-3" style="margin-bottom: 1em;">
            ...
            <input type="text" class="next-input" name="email_log_channel" id="email_log_channel" value="{{ setting('email_log_channel', config('mail.mailers.log.channel')) }}" placeholder="{{ trans('core/setting::setting.email.log_channel') }}">
          </div>
        </div>

        <div class="form-group mb-3">
          <label class="text-title-field" for="email_from_name">{{ trans('core/setting::setting.email.sender_name') }}</label>
          <input data-counter="60" type="text" class="next-input" name="email_from_name" id="email_from_name" value="{{ setting('email_from_name', config('mail.from.name')) }}" placeholder="{{ trans('core/setting::setting.email.sender_name_placeholder') }}">
        </div>

        <div class="form-group mb-3">
          <label class="text-title-field" for="email_from_address">{{ trans('core/setting::setting.email.sender_email') }}</label>
          <input data-counter="60" type="text" class="next-input" name="email_from_address" id="email_from_address" value="{{ setting('email_from_address', config('mail.from.address')) }}" placeholder="admin@example.com">
        </div>
